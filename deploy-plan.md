...
`https://SOS-backend.<subdomain>.workers.dev`
...
gh secret set VITE_BACKEND_URL --body "https://SOS-backend.<subdomain>.workers.dev"
```
...
curl https://SOS-backend.<subdomain>.workers.dev/health

# API docs (เปิดในเบราว์เซอร์)
# https://SOS-backend.<subdomain>.workers.dev/docs
...
npx wrangler d1 migrations apply SOS-db --remote
npm run deploy

# --- Frontend ---
cd ../frontend
pnpm install
VITE_BACKEND_URL="https://SOS-backend.<subdomain>.workers.dev" pnpm build
